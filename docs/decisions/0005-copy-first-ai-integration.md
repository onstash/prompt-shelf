...
## Context
Prompt Shelf should support ChatGPT, Claude, Gemini, and other tools without paying for model inference or becoming coupled to a provider.

## Decision
Prompt Shelf compiles and copies the completed prompt. It does not call AI APIs in the MVP. Opening an external AI tool may be supported, but execution and response storage remain outside Prompt Shelf.
...
- Prompt Shelf works across AI providers.
